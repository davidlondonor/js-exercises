...
var eligibleStudentNames = attendances.filter(losQueAtendieron => losQueAtendieron.some(asistieron => asistieron >= 8)).map(eligibleStudentNames => eligibleStudentNames[0]); 
